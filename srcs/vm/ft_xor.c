...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/08/03 11:58:22 by nolivier          #+#    #+#             */
/*   Updated: 2017/09/28 11:37:34 by nolivier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "vm.h"

static void		ft_print_xor(t_process *process, unsigned char **params,
	...
	t_process *process, unsigned char *memory)
{
	...
	ft_modif_carry_reg(process, params[2], 8);
}

int				ft_xor(t_settings *sets, t_process *process, t_process **begin)
{
	unsigned char	ocp;
	unsigned int	counter;
	unsigned char	*params[3];

	if (++process->cycle_count < (g_op_tab + 7)->cycles)
		return (1);
	...
	ft_print_xor(process, params, sets, counter);
