...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/08/03 11:57:08 by nolivier          #+#    #+#             */
/*   Updated: 2017/09/28 11:24:05 by nolivier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "vm.h"

static void		ft_print_or(t_process *process, unsigned char **params,
	...
	t_process *process, unsigned char *memory)
{
	...
	ft_modif_carry_reg(process, params[2], 7);
}

int				ft_or(t_settings *sets, t_process *process, t_process **begin)
{
	unsigned char	ocp;
	unsigned int	counter;
	unsigned char	*params[3];

	if (++process->cycle_count < (g_op_tab + 6)->cycles)
		return (1);
	...
	ft_print_or(process, params, sets, counter);
